...
!---------------------------------------------------------------------
      ...
      integer c, m
      integer(MPI_ADDRESS_KIND) lb, cell_disp(maxcells)
     ...
     &                          element, ierr)
       ...
       call MPI_Type_get_extent(element, lb, eltext, ierr)
...
!
       call MPI_Type_create_struct(ncells, cell_blength,  &
     &            cell_disp, cell_btype, combined_btype, ierr)
...
!
     ...
     &          element, cell_ftype(c), ierr)
       ...
       call MPI_Type_create_struct(ncells, cell_blength,  &
     &            cell_disp, cell_ftype, combined_ftype, ierr)

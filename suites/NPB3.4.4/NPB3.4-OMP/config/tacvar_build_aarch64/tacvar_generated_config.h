...
#define TACVAR_CONSUMER TACVAR_CONSUMER_NPB_OMP
#define TACVAR_ARCH_STR "aarch64"
#define TACVAR_TIMER_NAME "native(omp_get_wtime)"
#define TACVAR_TIMER_RESOLVED "omp_get_wtime"
